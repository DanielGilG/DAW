-- Ejercicio 1
CREATE OR REPLACE PROCEDURE es_jefe (e_id IN HR_EMPLOYEES.EMPLOYEE_ID%TYPE)
IS
v_count NUMBER;
...
BEGIN
    ...
    FROM HR_EMPLOYEES E
    WHERE E.MANAGER_ID = e_id;

    IF v_count > 0 THEN
        DBMS_OUTPUT.PUT_LINE('Es Jefe');
    ELSE
        DBMS_OUTPUT.PUT_LINE('No es Jefe');
    END IF;
